...
export default function CountriesSection() {
  ...
  const [countries, setCountries] = useState<Country[]>([
    // UNHRC Countries
    { name: "Afghanistan", committee: "UNHRC", taken: false },
    { name: "Argentina", committee: "UNHRC", taken: false },
    { name: "Australia", committee: "UNHRC", taken: true },
    { name: "Brazil", committee: "UNHRC", taken: false },
    { name: "Canada", committee: "UNHRC", taken: true },
    { name: "Colombia", committee: "UNHRC", taken: false },
    { name: "Egypt", committee: "UNHRC", taken: false },
